...
import { SERVICES } from '../../data/seoPageData';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mt-16 max-w-4xl mx-auto">
          <p className="text-slate-400 text-center leading-relaxed">
            ...
            Whether you need a{' '}
            <Link to="/services/city-tour" className="text-primary hover:underline">varanasi guided tour with English-speaking guides</Link>,
            a <Link to="/services/stay" className="text-primary hover:underline">hotel booking near Assi Ghat or Dashashwamedh</Link>,
            or a complete <Link to="/services/travel" className="text-primary hover:underline">varanasi to ayodhya tour package</Link>{' '}
