          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-[#1A120B] rounded-2xl border border-white/10 p-6 saffron-glow">
              ...
              <ul className="space-y-4 text-sm">
                ...
                <li className="flex items-start gap-3">
                  <span className="material-symbols-outlined text-green-500 text-lg flex-shrink-0 mt-0.5">check_circle</span>
                  <span className="text-slate-300"><strong className="text-white">Rating:</strong> 4.9★ on Google with 500+ verified reviews</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-[#1A120B] rounded-2xl border border-white/10 p-6">
              ...
              <nav className="space-y-3 text-sm">
                <Link to="/services/city-tour" className="flex items-center gap-2 text-slate-300 hover:text-primary transition-colors group">
                ...
                <Link to="/services/pooja-booking" className="flex items-center gap-2 text-slate-300 hover:text-primary transition-colors group">
                  <span className="material-symbols-outlined text-base text-primary/50 group-hover:text-primary">arrow_forward</span>
                  Pooja booking in Varanasi
                </Link>
                <Link to="/services/travel" className="flex items-center gap-2 text-slate-300 hover:text-primary transition-colors group">
                  <span className="material-symbols-outlined text-base text-primary/50 group-hover:text-primary">arrow_forward</span>
                  Travel packages
                </Link>
                <Link to="/services/stay" className="flex items-center gap-2 text-slate-300 hover:text-primary transition-colors group">
                  <span className="material-symbols-outlined text-base text-primary/50 group-hover:text-primary">arrow_forward</span>
                  Hotel stay near ghats
                </Link>
                <Link to="/services/event" className="flex items-center gap-2 text-slate-300 hover:text-primary transition-colors group">
                  <span className="material-symbols-outlined text-base text-primary/50 group-hover:text-primary">arrow_forward</span>
                  Event planning Varanasi
                </Link>
                <Link to="/blog" className="flex items-center gap-2 text-slate-300 hover:text-primary transition-colors group">
                  <span className="material-symbols-outlined text-base text-primary/50 group-hover:text-primary">arrow_forward</span>
