    ...
    <div className="min-h-screen bg-[#1A120B] text-slate-100">
      ...
      <section className="relative min-h-[40vh] sm:min-h-[50vh] flex items-end overflow-hidden">
        <div
          ...
          style={{ backgroundImage: `url('https://images.unsplash.com/photo-1561095531-7e41797d6712?auto=format&fit=crop&w=1920&q=85')` }}
        />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 pb-8 pt-28 w-full">
          <div className="max-w-2xl">
            <p className="text-primary text-xs font-bold tracking-[0.25em] uppercase mb-3">Everything You Need</p>
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white leading-tight mb-4">
              Our Services
            </h1>
            <p className="text-slate-300 text-base sm:text-lg leading-relaxed max-w-lg">
              Trusted, verified, and locally-rooted services for every aspect of your Varanasi journey — from the moment you land to the moment you leave.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-14 sm:py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
                ...
                <img
                  ...
                  onError={(e) => {
                    (e.target as HTMLImageElement).src =
                      'https://images.unsplash.com/photo-1561095531-7e41797d6712?auto=format&fit=crop&w=800&q=70';
                  }}
                />
        ...
        <div className="mt-8 sm:mt-10 bg-primary/10 border border-primary/20 rounded-2xl p-8 sm:p-10 text-center">
          <span className="material-symbols-outlined text-4xl sm:text-5xl text-primary mb-4 block">edit_note</span>
          <h3 className="text-xl sm:text-2xl font-bold text-white mb-3">Can&apos;t Find What You Need?</h3>
          <p className="text-slate-400 text-sm sm:text-base max-w-lg mx-auto mb-6 leading-relaxed">
            We create fully custom Varanasi itineraries tailored to your group, budget, and interests. Just tell us what you&apos;re looking for.
          </p>
          <Link
            to="/contact"
