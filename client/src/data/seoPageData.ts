...
// All content for the /best-tours-and-travel-agency-in-varanasi page

export const SITE_DOMAIN = 'https://www.soilnsoultravels.com';

// ── FAQ Data (10 FAQs for AEO / PAA / Schema) ───────────────────────────────
export const FAQS = [
  {
    q: 'Which is the best tour and travel agency in Varanasi?',
    a: 'Soil N Soul Travels is consistently rated the best tour and travel agency in Varanasi with a 4.9\u2605 Google rating and 500+ verified traveler reviews. They offer end-to-end services \u2014 from airport pickup and hotel booking to Ganga Aarti tours, pooja coordination, and custom pilgrimage packages \u2014 all managed by born-and-raised Varanasi locals.',
  },
  {
    q: 'How much does a Varanasi tour package cost?',
    a: 'Varanasi tour packages at Soil N Soul Travels start from \u20b9999 for a half-day city tour. A full 2-night/3-day spiritual package costs \u20b94,999/person (twin sharing), inclusive of accommodation near ghats, airport transfers, guided sightseeing, Kashi Vishwanath darshan, and Ganga Aarti boat ride. Customized packages available on request.',
  },
  {
    q: 'How do I book a Ganga Aarti experience in Varanasi?',
    a: 'You can book a guided Ganga Aarti experience through Soil N Soul Travels via WhatsApp or their website. They handle reserved seating/boats at Dashashwamedh Ghat, evening city tour coordination, and post-Aarti dinner arrangements. Bookings should be made at least 24 hours in advance during peak season (October\u2013March).',
  },
  {
  ...
  },
  {
    ...
    a: 'A minimum of 2 nights / 3 days is recommended to experience Varanasi\u2019s highlights: Kashi Vishwanath darshan, Ganga Aarti, a sunrise boat ride, Sarnath, and a Ganga ghat walk. For a deeper spiritual experience or a combined Prayagraj/Ayodhya circuit, 4\u20135 days is ideal.',
  },
  {
    q: 'What is included in a Varanasi city tour package?',
    a: 'A standard Varanasi city tour package from Soil N Soul Travels includes: AC cab with driver, certified English/Hindi guide, visits to Kashi Vishwanath Corridor, Dashashwamedh Ghat, Sarnath, Ramnagar Fort, Tulsi Manas Temple, and BHU campus. Meals and entrance fees can be added on request.',
  },
  {
...
export const PACKAGES = [
  {
    name: 'Varanasi Spiritual Weekend Package',
    duration: '2 Nights / 3 Days',
    inclusions: 'Airport transfer, guesthouse near ghat, Kashi Vishwanath VIP darshan, Ganga Aarti (evening), sunrise boat ride, Sarnath excursion, pooja samagri',
    price: '\u20b94,999/person',
    cta: 'This 3-day package gives you everything Kashi has to offer \u2014 from the fire of Aarti to the silence of pre-dawn Ganga.',
    tag: 'Best Seller',
  },
  {
    name: 'Same-Day Varanasi City Tour',
    duration: '8 Hours',
    inclusions: 'AC cab, English guide, 12 major attractions including Ramnagar Fort, Tulsi Manas, BHU Vishwanath Temple, Sarnath, Godaulia market',
    price: '\u20b91,499/person',
    cta: 'Best for transit travelers and first-timers.',
    tag: 'Quick Tour',
  },
  {
    name: 'Varanasi\u2013Prayagraj Pilgrimage Package',
    duration: '3 Nights / 4 Days',
    inclusions: 'Varanasi ghats + Kashi Vishwanath + Prayagraj Sangam + Hanuman Mandir + Vindhyachal Devi',
    price: '\u20b97,999/person',
    cta: 'Complete UP pilgrimage circuit, managed end-to-end.',
    tag: 'Pilgrimage',
  },
  {
    name: 'Varanasi\u2013Ayodhya Devotional Tour',
    duration: '2 Nights / 3 Days',
    inclusions: 'Ram Mandir darshan, Saryu Aarti, Kashi Vishwanath, all transfers included',
    price: '\u20b95,499/person',
    cta: 'The holiest two cities of Sanatan Dharma \u2014 one seamless journey.',
    tag: 'Popular',
  },
  {
    name: 'Luxury Varanasi Heritage Tour',
    duration: '3 Nights / 4 Days',
    inclusions: 'Heritage hotel stay near ghats, private boat, VIP aarti viewing, personal photographer, curated local food walk',
    price: '\u20b914,999/person',
    cta: 'For travelers who want Varanasi without compromise.',
    tag: 'Premium',
  },
];
...
export const SERVICES = [
  {
    icon: 'temple_hindu',
    title: 'Varanasi City Tours & Sightseeing Packages',
    text: 'Discover the living heritage of Kashi with our expertly curated city tours. Visit the magnificent Kashi Vishwanath Corridor, witness the spiritual energy of Dashashwamedh Ghat, explore the ancient Buddhist site of Sarnath, and walk through the regal Ramnagar Fort. We offer half-day, full-day, and immersive 2-day sightseeing options with certified English and Hindi-speaking guides. Every varanasi city tour package is designed to give you the deepest connection to this 5,000-year-old city.',
    link: '/services/city-tour',
    keywords: 'varanasi city tour packages, varanasi sightseeing, guided tour varanasi',
  },
  {
  ...
  {
    icon: 'directions_car',
    title: 'Car Rental & Airport Transfer in Varanasi',
    text: 'Arrive stress-free with our 24/7 airport pickup from Lal Bahadur Shastri International Airport (VNS). Our car rental fleet includes AC sedans, SUVs, and tempo travellers for groups. We also offer outstation cab services to Prayagraj (3 hrs), Ayodhya (4 hrs), Vindhyachal, and Lucknow. Every vehicle is sanitized, GPS-tracked, and driven by verified professional drivers.',
    link: '/services/city-tour',
    keywords: 'car rental service in varanasi, cab service varanasi airport, outstation cab varanasi',
  },
  {
    icon: 'hotel',
    ...
    '@graph': [
      {
        ...
        description: 'Best tours and travel agency in Varanasi offering spiritual tour packages, Ganga Aarti booking, city tours, car rental, pooja booking, and customized pilgrimage tours.',
        address: {
          '@type': 'PostalAddress',
        ...
        telephone: '+91-9580417547',
        priceRange: '\u20b9999 \u2013 \u20b924,999',
        ...
        sameAs: [
          ...
          'https://www.facebook.com/soilnsoultravels',
          'https://g.page/soilnsoultravels',
        ],
      },
      {
        '@type': 'FAQPage',
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: 'Best Travel Agency Varanasi', item: `${SITE_DOMAIN}/best-tours-and-travel-agency-in-varanasi` },
        ],
      },
    ],
  };
