            ...
            <div className="bg-[#1A120B] border border-white/10 rounded-t-3xl sm:rounded-2xl w-full sm:max-w-md shadow-2xl overflow-hidden">
                ...
                <form onSubmit={handleWhatsApp} className="px-6 py-5 space-y-4">
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <div>
                            <label className="text-xs text-slate-400 font-medium block mb-1">Phone / WhatsApp *</label>
                            <input
                                name="phone"
                                required
                                value={form.phone}
                    ...
                    <div>
                        <label className="text-xs text-slate-400 font-medium block mb-1">Service Interested In</label>
                        <select
                            name="service"
                            value={form.service}
                            onChange={handleChange}
                    ...
                    <div>
                        <label className="text-xs text-slate-400 font-medium block mb-1">Your Message</label>
                        <textarea
                            name="message"
                            value={form.message}
                            onChange={handleChange}
                            placeholder="e.g. I'm planning to visit Varanasi in March with my family..."
                            rows={3}
                    ...
                    <p className="text-center text-xs text-slate-500">
                        Or call us:{' '}
                        <a href="tel:+919580417547" className="text-primary font-medium">+91 95804 17547</a>
                    </p>
                </form>
            </div>
        </div>
