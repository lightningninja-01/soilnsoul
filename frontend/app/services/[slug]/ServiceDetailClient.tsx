                ...
                {hotels.length > 0 ? (
                  ...
                  >
                    {hotels.map((hotel) => (
                      <div
                        key={hotel._id}
                        className="min-w-[85%] sm:min-w-[48%] snap-start shrink-0 bg-white/5 border border-white/10 rounded-2xl overflow-hidden hover:border-primary/50 transition-all group flex flex-col"
                      >
                ...
                <div className="space-y-3">
                  {service.faqs.map((faq, i) => (
                    ...
                    >
                      ...
                      >
                        <h3 className="text-white font-semibold text-sm pr-4">{faq.q}</h3>
                        <span
