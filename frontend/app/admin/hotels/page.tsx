                ...
                {isEditing ? (
                                    ...
                                    <div className="flex-1 space-y-2">
                                        ...
                                        {currentHotel.image && (
                                            <button type="button" onClick={() => setCurrentHotel({...currentHotel, image: ''})} className="text-red-400 hover:text-red-300 text-xs flex items-center gap-1 mt-2">
                                                <span className="material-symbols-outlined text-[12px]">close</span> Remove Image
                                            </button>
                                        )}
                                    </div>
                                </div>
                    ...
                    <div className="bg-white/5 border border-white/10 p-6 rounded-2xl">
                        <div className="flex justify-between items-center mb-6">
                            ...
                            >
                                <span className="material-symbols-outlined text-[18px]">add_circle</span> Add Hotel
                            </button>
                        </div>
