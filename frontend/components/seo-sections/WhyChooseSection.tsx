      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-x-12 gap-y-10">
          ...
          <div className="flex items-start gap-5">
            ...
            <div>
              ...
              <p className="text-slate-400 leading-relaxed">
                ...
                travelers have given us a 4.9-star rating.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-5">
            ...
            <div>
              ...
              <p className="text-slate-400 leading-relaxed">
                ...
                not a we will get back to you during business hours email. Our local team is physically present in the city,
          ...
          <div className="flex items-start gap-5">
            ...
            <div>
              ...
              <p className="text-slate-400 leading-relaxed">
                ...
                roster of certified multilingual guides who can narrate the history of Sarnath Dhamek Stupa in fluent
          ...
          <div className="flex items-start gap-5">
            ...
            <div>
              <h3 className="text-xl font-bold text-white mb-3">4.9-star Rating Across Google, TripAdvisor & Travel Portals</h3>
              <p className="text-slate-400 leading-relaxed">
                Numbers do not lie. With a 4.9-star rating across Google Reviews and 500+ verified traveler testimonials,
