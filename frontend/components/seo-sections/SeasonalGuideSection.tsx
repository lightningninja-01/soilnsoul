        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-[#1A120B] rounded-2xl border border-white/5 overflow-hidden hover:border-orange-500/30 transition-all duration-300 group">
            ...
            <div className="p-8">
              ...
              <p className="text-slate-400 leading-relaxed">
                This is the golden window for visiting Varanasi. The weather is pleasant (15-25C), mornings on the
          ...
          <div className="bg-[#1A120B] rounded-2xl border border-white/5 overflow-hidden hover:border-yellow-500/30 transition-all duration-300 group">
            ...
            <div className="p-8">
              ...
              <p className="text-slate-400 leading-relaxed">
                Summers in Varanasi are intense, with temperatures climbing to 45C - but this is also when the city
                ...
                access premium ghat-view rooms at off-season prices. Soil N Soul summer packages focus on early
          ...
          <div className="bg-[#1A120B] rounded-2xl border border-white/5 overflow-hidden hover:border-blue-500/30 transition-all duration-300 group">
            ...
            <div className="p-8">
              ...
              <p className="text-slate-400 leading-relaxed">
                ...
                Vishwanath sees massive devotee turnout), <strong className="text-white">Nag Panchami</strong>
                (serpent worship at ancient temples), <strong className="text-white">Raksha Bandhan</strong>
                ceremonies at the ghats, and the breathtaking intensity of daily Ganga Aarti performed in monsoon rain.
                With fewer tourists, this is the season for truly immersive, authentic local experiences that most visitors
                never get to see. Soil N Soul monsoon packages include covered boat rides, temple-focused itineraries,
                indoor heritage walks through the silk weaving lanes, and curated culinary walks - perfect for travelers
                who want Kashi at its most raw and real.
              </p>
              <div className="mt-4 flex flex-wrap gap-2">
